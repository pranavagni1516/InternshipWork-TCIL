        ...
        >
          ...
          <div data-thq="thq-navbar-nav" className="home-desktop-menu">
            <nav className="home-links">
              ...
              <span className="home-nav42 bodySmall">Classes</span>
          ...
          >
            <div className="home-nav">
              ...
              <nav className="home-links1">
                ...
                <span className="home-nav421 bodySmall">Classes</span>
        ...
        <div className="heroContainer home-hero1">
          <div className="home-container01">
            ...
            <span className="home-hero-sub-heading bodyLarge">
              <span>
                <span>
                  <span>Achieve Your Goals with Professional Guidance</span>
                  <span>
                    <span
            ...
            <div className="home-btn-group">
              <button className="buttonFilled">Get Started Today</button>
          ...
          <div className="home-features1">
            <div className="home-container02">
              ...
              <h2 className="home-features-heading heading2">
                Powerful Features for Your Gym Website
              </h2>
              <span className="home-features-sub-heading bodyLarge">
                <span>
                  <span>
                    <span>
                      Take your gym&apos;s online presence to the next level
                      with our range of advanced features designed to enhance
            ...
            <div className="home-container03">
              <FeatureCard
                ...
                subHeading="Choose from a variety of professionally designed templates to create a unique website for your gym."
              ></FeatureCard>
              <FeatureCard
                heading="Class Schedule Integration"
                subHeading="Easily display and manage your gym's class schedule on your website for members to view and sign up."
              ></FeatureCard>
              <FeatureCard
                heading="Online Booking System"
                subHeading="Allow members to book classes, personal training sessions, and other services directly through your website."
              ></FeatureCard>
              <FeatureCard
                heading="Mobile Responsive Design"
                subHeading="Ensure that your gym website looks great and functions seamlessly on all devices, including smartphones and tablets."
              ></FeatureCard>
            </div>
          </div>
        </div>
        ...
        <div className="pricingContainer">
          <div className="home-container04">
            ...
            <span className="home-pricing-sub-heading bodyLarge">
              <span>
                <span>
                  Select the perfect plan that fits your fitness goals and
                  budget
                </span>
              </span>
            </span>
          ...
          <div className="home-container05">
            <div className="freePricingCard home-pricing-card">
              <div className="home-container06">
                ...
                <span className="bodySmall">
                  Access basic gym features for free
                </span>
              </div>
              ...
              <div className="home-container08">
                ...
                <div className="home-container10">
                  ...
                  <span className="bodySmall">Basic nutrition tips</span>
                </div>
                <div className="home-container11">
                  <span className="home-text42">✔</span>
                  <span className="bodySmall">Community support forum</span>
                </div>
                <div className="home-container12">
                  <span className="home-text43">✔</span>
                  <span className="bodySmall">Weekly fitness challenges</span>
                </div>
              </div>
            ...
            <div className="basicPricingCard home-pricing-card1">
              ...
              <div className="home-container15">
                ...
                <div className="home-container20">
                  ...
                  <span className="bodySmall">Progress tracking tools</span>
                </div>
              </div>
            ...
            <div className="proPricingCard home-pricing-card2">
              <div className="home-container21">
                ...
                <span className="bodySmall">
                  Get the ultimate fitness experience
                </span>
              </div>
              <div className="home-container22">
                ...
                <span className="home-pro-plan-pricing">39</span>
              ...
              <div className="home-container23">
                ...
                <div className="home-container25">
                  ...
                  <span className="bodySmall">Customized workout plans</span>
                </div>
      ...
      <div className="home-banner">
        <div className="bannerContainer home-banner1">
          <h1 className="home-banner-heading heading2">
            Welcome to Our Professional Gym Website
          </h1>
          <span className="home-banner-sub-heading bodySmall">
            <span>
              <span>
                <span>
                  Our gym is dedicated to helping you reach your fitness goals
                  through personalized training programs, state-of-the-art
                  equipment, and expert guidance from certified trainers.
                  Whether you&apos;re a beginner or a seasoned athlete, we have
                  everything you need to succeed on your fitness journey. Join
        ...
        <div className="faqContainer">
          <div className="home-faq1">
            ...
            <div className="home-container30">
              <Question1
                answer="Our gym is open from 6:00 AM to 10:00 PM every day of the week."
                question="What are your gym's operating hours?"
              ></Question1>
              <Question1
                answer="Yes, we have certified personal trainers available for one-on-one sessions tailored to your fitness goals."
                question="Do you offer personal training sessions?"
              ></Question1>
              <Question1
                answer="Our gym offers a variety of amenities including locker rooms, showers, sauna, and a smoothie bar."
                question="What amenities does your gym offer?"
              ></Question1>
              <Question1
                answer="Yes, all group fitness classes are included in the membership fee. Check our schedule for class timings."
                question="Are group fitness classes included in the membership?"
              ></Question1>
              <Question1
                answer="Yes, members can bring a guest for a small fee. Guest passes can be purchased at the front desk."
        ...
        <footer className="footerContainer home-footer1">
          <div className="home-container31">
            ...
            <nav className="home-nav1">
              ...
              <span className="home-nav422 bodySmall">Classes</span>
