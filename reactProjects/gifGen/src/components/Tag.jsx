...
const Tag = () => {
  ...
  async function fetchData(){
    ...
    const url = `https://api.giphy.com/v1/gifs/random?api_key=kPP90iBwNSiKi0RADfd9CT56vKdKzeFp&tag=&rating=g`;
  ...
  return (
    <div className='w-[900px]  mt-5 flex flex-col rounded-[40px] bg-blue-500 items-center mx-auto justify-evenly border border-black gap-y-4 mb-[20px]'>
      <h2 className='text-4xl font-bold border underline border-none mt-4'>RANDOM GIF</h2>
      ...
      <input className='w-[450px] text-lg text-center py-2 rounded-lg mb-[20px]' value={tag} onChange={changeHandler} type="text" />
